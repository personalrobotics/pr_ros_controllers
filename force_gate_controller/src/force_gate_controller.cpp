...
#include "force_gate_controller/force_gate_controller.hpp"
...
#include "force_gate_controller/trajectory.hpp"
...
{
ForceGateController::ForceGateController()
: controller_interface::ControllerInterface(), dof_(0)
{
}

controller_interface::CallbackReturn ForceGateController::on_init()
{
  try
  {
...
ForceGateController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
ForceGateController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf;
  conf.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
bool ForceGateController::check_wrench_threshold(const rclcpp::Time & time)
{
  // Check if enabled
...
controller_interface::return_type ForceGateController::update(
...
void ForceGateController::read_state_from_hardware(JointTrajectoryPoint & state)
{
...
bool ForceGateController::read_state_from_command_interfaces(JointTrajectoryPoint & state)
{
...
bool ForceGateController::read_commands_from_command_interfaces(
...
void ForceGateController::query_state_service(
...
controller_interface::CallbackReturn ForceGateController::on_configure(
  const rclcpp_lifecycle::State &)
{
  ...
  if ((dof_ > 0) && (params_.joints.size() != dof_))
  {
    RCLCPP_ERROR(
      logger,
      "The ForceGateController does not support restarting with a different number of DOF");
  ...
  joint_command_subscriber_ =
    get_node()->create_subscription<trajectory_msgs::msg::JointTrajectory>(
      ...
      std::bind(&ForceGateController::topic_callback, this, std::placeholders::_1));
  ...
  action_server_ = rclcpp_action::create_server<FollowJTrajAction>(
    ...
    std::bind(&ForceGateController::goal_received_callback, this, _1, _2),
    std::bind(&ForceGateController::goal_cancelled_callback, this, _1),
    std::bind(&ForceGateController::goal_accepted_callback, this, _1));
  ...
  query_state_srv_ = get_node()->create_service<control_msgs::srv::QueryTrajectoryState>(
    ...
    std::bind(&ForceGateController::query_state_service, this, _1, _2));
...
controller_interface::CallbackReturn ForceGateController::on_activate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn ForceGateController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
  for (size_t index = 0; index < dof_; ++index)
  {
...
controller_interface::CallbackReturn ForceGateController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  // go home
...
controller_interface::CallbackReturn ForceGateController::on_error(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
bool ForceGateController::reset()
{
  subscriber_is_active_ = false;
...
controller_interface::CallbackReturn ForceGateController::on_shutdown(
  const rclcpp_lifecycle::State &)
{
...
void ForceGateController::publish_state(
...
void ForceGateController::topic_callback(
...
rclcpp_action::GoalResponse ForceGateController::goal_received_callback(
...
rclcpp_action::CancelResponse ForceGateController::goal_cancelled_callback(
...
void ForceGateController::goal_accepted_callback(
...
void ForceGateController::fill_partial_goal(
...
void ForceGateController::sort_to_local_joint_order(
...
bool ForceGateController::validate_trajectory_point_field(
...
bool ForceGateController::validate_trajectory_msg(
...
void ForceGateController::add_new_trajectory_msg(
  const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> & traj_msg)
{
  traj_msg_external_point_ptr_.writeFromNonRT(traj_msg);
}

void ForceGateController::preempt_active_goal()
{
  const auto active_goal = *rt_active_goal_.readFromNonRT();
  if (active_goal)
  {
...
std::shared_ptr<trajectory_msgs::msg::JointTrajectory>
ForceGateController::set_hold_position()
{
...
bool ForceGateController::contains_interface_type(
...
void ForceGateController::resize_joint_trajectory_point(
...
void ForceGateController::resize_joint_trajectory_point_command(
  trajectory_msgs::msg::JointTrajectoryPoint & point, size_t size)
{
  if (has_position_command_interface_)
  {
...
bool ForceGateController::has_active_trajectory()
{
...
PLUGINLIB_EXPORT_CLASS(
  force_gate_controller::ForceGateController, controller_interface::ControllerInterface)
