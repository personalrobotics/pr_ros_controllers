...
{
class TestableForceGateController
: public force_gate_controller::ForceGateController
{
public:
  using force_gate_controller::ForceGateController::ForceGateController;
  using force_gate_controller::ForceGateController::validate_trajectory_msg;

  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = force_gate_controller::ForceGateController::on_configure(previous_state);
...
public:
  ...
  virtual void SetUp()
  {
    controller_name_ = "test_force_gate_controller";
  ...
  {
    traj_controller_ = std::make_shared<TestableForceGateController>();
  ...
  std::shared_ptr<TestableForceGateController> traj_controller_;
