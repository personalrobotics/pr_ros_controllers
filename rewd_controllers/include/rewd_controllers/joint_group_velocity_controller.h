...
#ifndef REWD_CONTROLLERS__JOINT_GROUP_VELOCITY_CONTROLLER_H
#define REWD_CONTROLLERS__JOINT_GROUP_VELOCITY_CONTROLLER_H

/**
   @class rewd_controllers::JointGroupVelocityController
   ...
   @param type Must be "rewd_controllers::JointGroupVelocityController"
...
namespace rewd_controllers {
  ...
  public:
    ...
    virtual ~JointGroupVelocityController();
